    ...
    public partial class IssueBooks : Form
    {
        ...
        private void IssueBooks_Load(object sender, EventArgs e)
        {
            ...
            while (rdr.Read())
            {
                ...
                {
                    comboBoxBookPicker.Items.Add(rdr.GetString(i));
        ...
        private void btnIssueBook_Click(object sender, EventArgs e)
        {
            if(txtName.Text != "")
            {
                if(comboBoxBookPicker.SelectedIndex != -1 && count <=2) 
                {
                    ...
                    String bookname = comboBoxBookPicker.Text;
                    String bookIssueDate = dateTimePickerBookIssue.Text;
                ...
                {
                    MessageBox.Show("Select Book or Maximun number of Book is ISSUED", "No Book Selected", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
